...
export const Icon: React.FC<IconProps> = ({ name, size = 16 }) => {
  const icons: Record<string, React.ReactNode> = {
    home: <><rect x="3" y="9" width="18" height="13" rx="2"/><path d="M1 9L12 2l11 7"/></>,
    trips: <><rect x="3" y="4" width="18" height="17" rx="2"/><path d="M8 4V2M16 4V2M3 10h18"/></>,
    create: <><circle cx="12" cy="12" r="10"/><path d="M12 8v8M8 12h8"/></>,
    builder: <><path d="M4 6h16M4 12h16M4 18h16"/></>,
    ...
    pack: <><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9,22 9,12 15,12 15,22"/></>,
